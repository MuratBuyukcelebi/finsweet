    ...
    <div class="row">
      ...
      <div class="col-xl-4">
        <div class="benefits-item">
          ...
          <div class="benefits-item__title">Customize with ease</div>
          <div class="benefits-item__description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ut enim.</div>
        </div>
      </div>
      <div class="col-xl-4">
        <div class="benefits-item">
          <div class="benefits-item__icon">
            <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clip-path="url(#clip0_1356_488)">
              ...
              <defs>
                <clipPath id="clip0_1356_488">
                  <rect width="35" height="35" fill="white"/>
                </clipPath>
              </defs>
            </svg>
          </div>
          <div class="benefits-item__title">Perfectly Responsive</div>
          <div class="benefits-item__description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ut enim.</div>
        </div>
      </div>
      <div class="col-xl-4">
        <div class="benefits-item">
          ...
          <div class="benefits-item__title">Friendly Support</div>
          <div class="benefits-item__description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ut enim.</div>
        </div>
      </div>
    </div>
    <div class="benefits__logo">
      <div class="benefits__logo-title">
        <span class="benefits__logo-number">100.000+</span>
